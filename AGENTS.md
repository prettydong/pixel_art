...
- 约定比例为 **1 个设计像素 = 3 × 3 个物理像素**。渲染前读取屏幕尺寸、窗口尺寸和 `devicePixelRatio`，CSS 基础单位为 `3 / devicePixelRatio` px。
...
- 固定物理像素比例在不同 DPR 下对应不同 CSS 字号。浏览器无法绕过操作系统额外的显示缩放，不能声称所有显示环境都能绝对无抗锯齿。
